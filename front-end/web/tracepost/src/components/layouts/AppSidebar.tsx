...
const navItems: NavItem[] = [
  ...
  },
  {
    name: 'Users',
    icon: <TableIcon />,
    subItems: [{ name: 'User List', path: '/admin//user-tables', pro: false }]
  },
  {
    name: 'Hatchery ',
    icon: <TableIcon />,
    subItems: [{ name: 'Hatchery List', path: '/admin/hatchery-tables', pro: false }]
  },
  {
    name: 'Distributors  ',
    icon: <TableIcon />,
    ...
    >
      <div className={`py-5 flex  ${!isExpanded && !isHovered ? 'lg:justify-center' : 'justify-start'}`}>
        <Link href='/'>
          {isExpanded || isHovered || isMobileOpen ? (
            <>
              <Image className='dark:hidden' src='/img/logo_word.png' alt='Logo' width={150} height={40} />
