        ...
        <div>
          ...
          <div className='grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32'>
            ...
            <div>
              ...
              <p className='text-sm font-medium text-gray-800 dark:text-white/90'>nguyengiachan.gr2020@gmail.com</p>
            </div>

            <div>
              <p className='mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400'>Phone</p>
              <p className='text-sm font-medium text-gray-800 dark:text-white/90'>+84 949 360 729</p>
            </div>
