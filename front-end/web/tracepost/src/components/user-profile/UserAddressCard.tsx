          ...
          <div>
            ...
            <div className='grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32'>
              <div>
                ...
                <p className='text-sm font-medium text-gray-800 dark:text-white/90'>Viet Nam</p>
              </div>

              <div>
                <p className='mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400'>City/State</p>
                <p className='text-sm font-medium text-gray-800 dark:text-white/90'>Ninh Kieu, Can Tho, Viet Nam.</p>
              </div>

              <div>
                <p className='mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400'>Postal Code</p>
                <p className='text-sm font-medium text-gray-800 dark:text-white/90'>ERT 2089</p>
              </div>

              <div>
                <p className='mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400'>Identification Card</p>
                <p className='text-sm font-medium text-gray-800 dark:text-white/90'>095204000965</p>
              </div>
            </div>
          </div>
